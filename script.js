...
function toggleSolution1_3() {
  ...
  var img4 = document.getElementById("solution-img1-4");
...
function toggleSolution1_4() {
  var img5 = document.getElementById("solution-img1-5");
...
function toggleSolution1_6() {
  var img7 = document.getElementById("solution-img1-7");
  var img8 = document.getElementById("solution-img1-8");
  if (img7.style.display === "none" && img8.style.display === "none") {
...
function toggleSolution1_7() {
  var img9 = document.getElementById("solution-img1-9");
...
function toggleSolution2_3() {
  ...
  const img3 = document.getElementById("solution-img2-3-2");


  const isHidden = img1.style.display === "none" && img2.style.display === "none" && img3.style.display === "none";
  
  img1.style.display = isHidden ? "block" : "none";
  img2.style.display = isHidden ? "block" : "none";
  img3.style.display = isHidden ? "block" : "none";
}
...
function toggleSolution2_6() {
  ...
  const img3 = document.getElementById("solution-img2-6-2");
  const img4 = document.getElementById("solution-img2-6-3");

  const isHidden = img1.style.display === "none" && img2.style.display === "none" && img3.style.display === "none" && img4.style.display === "none";
  
  img1.style.display = isHidden ? "block" : "none";
  img2.style.display = isHidden ? "block" : "none";
  img3.style.display = isHidden ? "block" : "none";
  img4.style.display = isHidden ? "block" : "none";
}
